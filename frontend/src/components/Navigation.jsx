...
export const Sidebar = ({ collapsed = false, onToggle }) => {
  ...
  return (
    ...
    >
      <div className={cn("mb-8 flex min-h-12 items-center gap-3", collapsed ? "w-full justify-center" : "px-8 translate-x-2")}>
        <BrandLogo variant="white" className={cn("w-11 h-11 shrink-0", collapsed && "translate-x-1")} />
