export default function AuthLayout({ children, eyebrow = "IPB Lost & Found", title = "Welcome to Lost & Found IPB", subtitle = "Temukan barangmu atau Bantu Pengguna Lain Menemukan Barangnya" }) {
  return (
